...
//    fn and_test() {
//        //Both pass
//        let command1 = "ls /".to_string();
//        let command2 = "ls /".to_string();
//        assert_eq!(true, and(command1,command2));
//
//        //First Fails
//        let command3 = "ls /blah".to_string();
//        let command4 = "ls /".to_string();
//        assert_eq!(false, and(command3,command4));
//
//        //Last Fails
//        let command5 = "ls /".to_string();
//        let command6 = "ls /blah".to_string();
//        assert_eq!(true, and(command5,command6));
//
//        //Both fail
//        let command7 = "ls /blah".to_string();
//        let command8 = "ls /blah".to_string();
